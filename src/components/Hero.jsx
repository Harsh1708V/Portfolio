        ...
        <div className="flex flex-wrap lg:flex-row-reverse">
            <div className="w-full lg:w-1/2">
                <div className="flex justify-center lg:p-8">
                    <motion.img
                        src={profilePic} alt="Harsh Waibhav" className="border border-s-stone-900 rounded-3xl"
                        width={650}
                        height={650}
            ...
            <div className="w-full lg:w-1/2">
                <motion.div
                    ...
                    <motion.h2
                        ...
                        className="pb-2 text-4xl tracking-tighter lg:text-8xl">Harsh Waibhav</motion.h2>
                    <motion.span
                        variants={childVariants}
